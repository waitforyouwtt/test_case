...
public class AlipayCore {
     ...
     * @param sWord 要写入日志里的文本内容 The string to be written in your log
     */
     ...
     * @param strFilePath 文件路径File path
     * @param file_digest_type 摘要算法file algorithm
     * @return 文件摘要结果file summary result
     */
